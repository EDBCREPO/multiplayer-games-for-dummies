...
var ASM_CONSTS = {
  108560: () => { if (document.fullscreenElement) return 1; },  
 108606: () => { return document.getElementById('canvas').width; },  
 108658: () => { return parseInt(document.getElementById('canvas').style.width); },  
 108726: () => { document.exitFullscreen(); },  
 108753: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 108826: () => { if (document.fullscreenElement) return 1; },  
 108872: () => { return document.getElementById('canvas').width; },  
 108924: () => { return screen.width; },  
 108949: () => { document.exitFullscreen(); },  
 108976: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 109109: () => { return window.innerWidth; },  
 109135: () => { return window.innerHeight; },  
 109162: () => { if (document.fullscreenElement) return 1; },  
 109208: () => { return document.getElementById('canvas').width; },  
 109260: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109328: () => { if (document.fullscreenElement) return 1; },  
 109374: () => { return document.getElementById('canvas').width; },  
 109426: () => { return screen.width; },  
 109451: () => { return window.innerWidth; },  
 109477: () => { return window.innerHeight; },  
 109504: () => { if (document.fullscreenElement) return 1; },  
 109550: () => { return document.getElementById('canvas').width; },  
 109602: () => { return screen.width; },  
 109627: () => { document.exitFullscreen(); },  
 109654: () => { if (document.fullscreenElement) return 1; },  
 109700: () => { return document.getElementById('canvas').width; },  
 109752: () => { return parseInt(document.getElementById('canvas').style.width); },  
 109820: () => { document.exitFullscreen(); },  
 109847: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 109905: () => { return screen.width; },  
 109930: () => { return screen.height; },  
 109956: () => { return window.screenX; },  
 109983: () => { return window.screenY; },  
 110010: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 110063: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 110134: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 110191: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 110447: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 110518: () => { if (document.fullscreenElement) return 1; },  
 110564: () => { return window.innerWidth; },  
 110590: () => { return window.innerHeight; },  
 110617: () => { if (document.pointerLockElement) return 1; }
};
